...
UENUM(BlueprintType)
enum class EOmniOutputFormat : uint8 { PNGSequence, NVENCHardware };
...
struct FOmniCaptureSettings
{
	...
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "Output") EOmniOutputFormat OutputFormat = EOmniOutputFormat::PNGSequence;
